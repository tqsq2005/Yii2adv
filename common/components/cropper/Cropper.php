...
{
    /** @var string text for button */
    public $buttonText = '修改头像';
    ...
    public $defaultPluginOptions = [
        'strict' => true,
        'autoCropArea' => 0.5,//初始裁剪区域0-1之间，default：1  即选定了整张图片
        'checkImageOrigin' => false,
        'checkCrossOrigin' => false,
        'checkOrientation' => false,
        'zoomable' => true,//可缩放 default: true
        'preview'  => '.cropper-img-preview',//裁剪预览区域
        //'minContainerWidth' => '458',//The minimum width of the container. default:200
        //'minContainerHeight' => '315',//The minimum height of the container. default:100
    ];
    ...
    public function run()
    {
        ...
        if ($this->modal) {
            ...
            $content .= Html::a('<i class="glyphicon glyphicon-scissors"></i> '.$this->buttonText, '#' . $this->id,
                ArrayHelper::merge([
                    'data' => [
                        'toggle' => 'modal',
                        'target' => '#' . $this->id,
