...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="row">
            <div class="col-xs-8">
                <?= $form->field($model, 'rememberMe', ['inputOptions' => ['tabindex' => '4']])->label('一个月内自动登录', ['id' => 'login-form-rememberme-label', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom','class' => 'text-danger', 'title' => '警告：公共环境下请勿勾选！'])->checkbox(['value' => 0]) ?>
            </div>
            <!-- /.col -->
            <div class="col-xs-4">
                <?= Html::submitButton('登 录', ['class' => 'btn btn-primary btn-block btn-flat', 'id' => 'login-form-submit', 'name' => 'login-button', 'inputOptions' => ['tabindex' => '3']]) ?>
            </div>
            <!-- /.col -->
        </div>
        ...
        <a href="#" id="login-help" class="text-info" style="line-height: 40px;"><i class="fa fa-question-circle"></i> <span id="login-help-label">登录指引</span></a><br>
        <a href="<?= \yii\helpers\Url::to(['/user/recovery/request'])?>" id="login-forgetpw" class="text-warning"><i class="fa fa-user-secret"></i> 忘记密码</a><br>
        ...
        (function(){
            ...
            $('#login-help').on('click', function(e) {
                ...
                var tour = new Tour({
                    ...
                    steps: [
                        {
                            element: "#login-form-login",
                            title: "第一步",
                            content: "输入您的用户名、邮箱或手机号！"
                        },
                        {
                            element: "#login-form-password",
                            title: "第二步",
                            content: "输入您用户名对应的密码！"
                        },
                        {
                            element: "#login-form-rememberme",
                            placement: "bottom",
                            title: "第三步",
                            content: "如果是您私人电脑可以勾选，这样一个月内就可以自动登录了！公共环境请谨慎选择！！"
                        },
                        {
                            element: "#login-form-submit",
                            title: "最后",
                            content: "按回车键或点击 登录 按钮登录！"
                        }
                    ]});
            ...
            $('#login-form-rememberme').click(function(e) {
                ...
                if($(this).is(':checked')) {
                    //$(this).addClass('animated shake');
                    $('#login-form-rememberme-label').addClass('animated shake');
                } else {
                    //$(this).removeClass('animated shake');
                    $('#login-form-rememberme-label').removeClass('animated shake');
                }
            });
