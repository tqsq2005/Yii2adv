...
use common\populac\widgets\ReCaptcha;

/**
 * Guestbook module API
 * @package common\populac\modules\guestbook\api
 *
...
class Guestbook extends \common\populac\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        $form = ActiveForm::begin([
            ...
            'action' => Url::to(['/populac/guestbook/send'])
        ]);
