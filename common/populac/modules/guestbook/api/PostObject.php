<?php
namespace common\populac\modules\guestbook\api;

use Yii;
use common\populac\components\API;
use yii\helpers\Url;

class PostObject extends \common\populac\components\ApiObject
{
    public $image;
    public $time;
    ...
    public function getEditLink(){
        return Url::to(['/populac/guestbook/a/edit', 'id' => $this->id]);
    }
}