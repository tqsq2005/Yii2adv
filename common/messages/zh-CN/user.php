...
return [
    ...
    'Account details have been updated' => '基本信息已更新',
    ...
    'Not blocked' => '未锁定',
    'Permissions' => '',
    'Profile details' => '更多资料',
    'Profile details have been updated' => '信息已更新',
    ...
    'Yandex' => '',
    'You can assign multiple roles or permissions to user by using the form below' => '允许添加多个模块权限',
    ...
    'Confirmation' => '审核情况',
    'Confirmed' => '已审核',
    'Confirmed at {0, date, MMMM dd, YYYY HH:mm}' => '{0, date,  YYYY年MMMM dd日, HH:mm} 审核通过',
    'Connect' => '连接',
    'Continue' => '继续',
    ...
    '{0, date, MMMM dd, YYYY HH:mm}' => '{0, date, Y年M月d日,  HH:mm}',
];
