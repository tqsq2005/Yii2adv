...
use common\modules\preferences\models\Preferences;

/**
 * PreferencesSearch represents the model behind the search form about `common\modules\preferences\models\Preferences`.
 */
