            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="box box-solid" id="map-unit-help-text">
                        ...
                        <div class="box-body">
                            <ol>
                                <li id="unit-detail">当前为选中任何单位(部门)</li>
                                <li>单位(部门)名称点击鼠标右键：
                                    <ol>
...
//                console.log(data.selected);
                    ...
                    $('#unit-detail').html('当前单位(部门)为：(<span class="text-danger">'+ data.selected.join(',') +'</span>) ' + data.node.text);
                } else {
                    $('#unit-detail').html('当前为选中任何单位(部门)');
                }
            });
        //点击更新单位权限列表
        $(document)
